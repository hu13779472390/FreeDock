namespace DemoApplication
{
	partial class frmMain
	{
		...
		private void InitializeComponent()
		{
			...
			FQ.FreeDock.DocumentContainer documentContainer1;
			FQ.FreeDock.DockContainer dockContainer3;
            ...
            treeNode28,
            treeNode29});
			this.tdWelcome = new FQ.FreeDock.TabbedDocument();
			this.richTextBox1 = new System.Windows.Forms.RichTextBox();
			this.sandDockManager1 = new FQ.FreeDock.SandDockManager();
			this.panel1 = new System.Windows.Forms.Panel();
			this.dwToolbox = new FQ.FreeDock.DockableWindow();
			this.lvwTools = new System.Windows.Forms.ListView();
			this.ilTools = new System.Windows.Forms.ImageList(this.components);
			this.dockContainer2 = new FQ.FreeDock.DockContainer();
			this.dwOutput = new FQ.FreeDock.DockableWindow();
			this.txtEventLog = new System.Windows.Forms.TextBox();
			this.dwTaskList = new FQ.FreeDock.DockableWindow();
			this.textBox1 = new System.Windows.Forms.TextBox();
			this.dockContainer1 = new FQ.FreeDock.DockContainer();
			this.dwAppearance = new FQ.FreeDock.DockableWindow();
			this.tvwRenderer = new System.Windows.Forms.TreeView();
			this.dwNewWindows = new FQ.FreeDock.DockableWindow();
			this.dwBehavior = new FQ.FreeDock.DockableWindow();
			...
			this.dwClassView = new FQ.FreeDock.DockableWindow();
			...
			documentContainer1 = new FQ.FreeDock.DocumentContainer();
			dockContainer3 = new FQ.FreeDock.DockContainer();
			...
			documentContainer1.LayoutSystem = new FQ.FreeDock.SplitLayoutSystem(new System.Drawing.SizeF(534F, 329F), System.Windows.Forms.Orientation.Horizontal, new FQ.FreeDock.LayoutSystemBase[] {
            ((FQ.FreeDock.LayoutSystemBase)(new FQ.FreeDock.DocumentLayoutSystem(new System.Drawing.SizeF(534F, 329F), new FQ.FreeDock.DockControl[] {
                        ((FQ.FreeDock.DockControl)(this.tdWelcome))}, this.tdWelcome)))});
			...
			this.sandDockManager1.ResolveDockControl += new FQ.FreeDock.ResolveDockControlEventHandler(this.sandDockManager1_ResolveDockControl);
			this.sandDockManager1.DockingFinished += new System.EventHandler(this.sandDockManager1_DockingFinished);
			this.sandDockManager1.DockControlRemoved += new FQ.FreeDock.DockControlEventHandler(this.sandDockManager1_DockControlRemoved);
			this.sandDockManager1.DockControlActivated += new FQ.FreeDock.DockControlEventHandler(this.sandDockManager1_DockControlActivated);
			this.sandDockManager1.ShowControlContextMenu += new FQ.FreeDock.ShowControlContextMenuEventHandler(this.sandDockManager1_ShowControlContextMenu);
			this.sandDockManager1.ShowActiveFilesList += new FQ.FreeDock.ActiveFilesListEventHandler(this.sandDockManager1_ShowActiveFilesList);
			this.sandDockManager1.DockControlClosing += new FQ.FreeDock.DockControlClosingEventHandler(this.sandDockManager1_DockControlClosing);
			this.sandDockManager1.DockControlAdded += new FQ.FreeDock.DockControlEventHandler(this.sandDockManager1_DockControlAdded);
			// 
			// panel1
			// 
			...
			dockContainer3.LayoutSystem = new FQ.FreeDock.SplitLayoutSystem(new System.Drawing.SizeF(108F, 331F), System.Windows.Forms.Orientation.Horizontal, new FQ.FreeDock.LayoutSystemBase[] {
            ((FQ.FreeDock.LayoutSystemBase)(new FQ.FreeDock.ControlLayoutSystem(new System.Drawing.SizeF(108F, 331F), new FQ.FreeDock.DockControl[] {
                        ((FQ.FreeDock.DockControl)(this.dwToolbox))}, this.dwToolbox)))});
			...
			this.dwToolbox.BorderStyle = FQ.FreeDock.Rendering.BorderStyle.Flat;
			...
			this.dockContainer2.LayoutSystem = new FQ.FreeDock.SplitLayoutSystem(new System.Drawing.SizeF(648F, 170F), System.Windows.Forms.Orientation.Vertical, new FQ.FreeDock.LayoutSystemBase[] {
            ((FQ.FreeDock.LayoutSystemBase)(new FQ.FreeDock.ControlLayoutSystem(new System.Drawing.SizeF(385F, 170F), new FQ.FreeDock.DockControl[] {
                        ((FQ.FreeDock.DockControl)(this.dwOutput)),
                        ((FQ.FreeDock.DockControl)(this.dwTaskList))}, this.dwOutput)))});
			...
			// dwOutput
			// 
			this.dwOutput.BorderStyle = FQ.FreeDock.Rendering.BorderStyle.Flat;
			...
			// dwTaskList
			// 
			this.dwTaskList.BorderStyle = FQ.FreeDock.Rendering.BorderStyle.Flat;
			...
			this.dockContainer1.LayoutSystem = new FQ.FreeDock.SplitLayoutSystem(new System.Drawing.SizeF(250F, 505F), System.Windows.Forms.Orientation.Horizontal, new FQ.FreeDock.LayoutSystemBase[] {
            ((FQ.FreeDock.LayoutSystemBase)(new FQ.FreeDock.ControlLayoutSystem(new System.Drawing.SizeF(250F, 246.491F), new FQ.FreeDock.DockControl[] {
                        ((FQ.FreeDock.DockControl)(this.dwAppearance)),
                        ((FQ.FreeDock.DockControl)(this.dwNewWindows))}, this.dwAppearance))),
            ((FQ.FreeDock.LayoutSystemBase)(new FQ.FreeDock.ControlLayoutSystem(new System.Drawing.SizeF(250F, 255.509F), new FQ.FreeDock.DockControl[] {
                        ((FQ.FreeDock.DockControl)(this.dwBehavior)),
                        ((FQ.FreeDock.DockControl)(this.dwClassView))}, this.dwBehavior)))});
			...
			// dwAppearance
			// 
			this.dwAppearance.BorderStyle = FQ.FreeDock.Rendering.BorderStyle.Flat;
			...
			this.dwNewWindows.BorderStyle = FQ.FreeDock.Rendering.BorderStyle.Flat;
			...
			this.dwBehavior.BorderStyle = FQ.FreeDock.Rendering.BorderStyle.Flat;
			...
			// dwClassView
			// 
			this.dwClassView.BorderStyle = FQ.FreeDock.Rendering.BorderStyle.Flat;
		...
		private FQ.FreeDock.SandDockManager sandDockManager1;
		private FQ.FreeDock.DockContainer dockContainer2;
		private System.Windows.Forms.TextBox txtEventLog;
		private FQ.FreeDock.DockContainer dockContainer1;
		private System.Windows.Forms.RichTextBox richTextBox1;
		private FQ.FreeDock.DockableWindow dwAppearance;
		private FQ.FreeDock.DockableWindow dwTaskList;
		private FQ.FreeDock.DockableWindow dwOutput;
		private FQ.FreeDock.DockableWindow dwToolbox;
		private FQ.FreeDock.DockableWindow dwClassView;
		private FQ.FreeDock.DockableWindow dwBehavior;
		private FQ.FreeDock.TabbedDocument tdWelcome;
		...
		private FQ.FreeDock.DockableWindow dwNewWindows;
