...
namespace DemoApplication
{
	...
	public partial class frmMain : System.Windows.Forms.Form
	{
        ...
        private void sandDockManager1_DockControlAdded(object sender, FQ.FreeDock.DockControlEventArgs e)
		{
        ...
        private void sandDockManager1_DockControlRemoved(object sender, FQ.FreeDock.DockControlEventArgs e)
		{
		...
		private void sandDockManager1_ResolveDockControl(object sender, FQ.FreeDock.ResolveDockControlEventArgs e)
		{
		...
		private void sandDockManager1_DockControlActivated(object sender, FQ.FreeDock.DockControlEventArgs e)
		{
		...
		private void sandDockManager1_ActiveTabbedDocumentChanged(object sender, System.EventArgs e)
		{
		...
		private void sandDockManager1_DockControlClosing(object sender, FQ.FreeDock.DockControlClosingEventArgs e)
		{
		...
		private void sandDockManager1_ShowControlContextMenu(object sender, FQ.FreeDock.ShowControlContextMenuEventArgs e)
		{
		...
		private void Form2_Load(object sender, System.EventArgs e)
		{
			...
			Stream stream = this.GetType().Assembly.GetManifestResourceStream("DemoApplication.welcome.rtf");
		...
		private void sandDockManager1_DockingStarted(object sender, System.EventArgs e)
		{
		...
		private void sandDockManager1_DockingFinished(object sender, System.EventArgs e)
		{
		...
		{
			MessageBox.Show(this, "SandDock Demonstration Application" + Environment.NewLine + Environment.NewLine + "SandDock Version " + typeof(SandDockManager).Assembly.GetName().Version.ToString(), "About");
		}
		...
		private void btnFloatWindows_Click(object sender, System.EventArgs e)
		{
		...
		private Type[] WinformsToolBoxTypes
		{
			get
			{
				return new Type[] { typeof(Button), typeof(CheckBox), typeof(CheckedListBox), typeof(ColorDialog), typeof(ComboBox), typeof(ContextMenu)
									  ...
									  , typeof(RadioButton), typeof(RichTextBox), typeof(SaveFileDialog), typeof(Splitter), typeof(StatusBar), typeof(System.Windows.Forms.TabControl)
		...
		private Type[] DataToolBoxTypes
		{
			get
			{
				return new Type[] { typeof(DataSet), typeof(System.Data.OleDb.OleDbDataAdapter), typeof(System.Data.OleDb.OleDbConnection), typeof(System.Data.OleDb.OleDbCommand), typeof(System.Data.SqlClient.SqlDataAdapter), typeof(System.Data.SqlClient.SqlConnection), typeof(System.Data.SqlClient.SqlCommand), typeof(System.Data.Odbc.OdbcDataAdapter), typeof(System.Data.Odbc.OdbcConnection), typeof(System.Data.Odbc.OdbcCommand), typeof(DataView) };
			}
		}
		...
		{
			Color[] oneNoteColours = new Color[] { Color.FromArgb(138, 168, 228), Color.FromArgb(145, 186, 174), Color.FromArgb(246, 176, 120),
		...
		private void tvwRenderer_AfterSelect(object sender, TreeViewEventArgs e)
		{
			...
			sandDockManager1.BorderStyle = sandDockManager1.Renderer is Office2007Renderer ? FQ.FreeDock.Rendering.BorderStyle.None : FQ.FreeDock.Rendering.BorderStyle.Flat;
