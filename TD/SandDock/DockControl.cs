...
label_10:
      ...
      goto label_14;
label_3:
      if ((uint) x53c0846b47593790 + (uint) x53c0846b47593790 >= 0U && 0 != 0)
        return;
      else
        goto label_1;
label_11:
...
label_5:
      ...
      if ((uint) xc481dbe8dc50af3f >= 0U)
      {
        ...
        goto label_15;
label_9:
      if ((uint) xc481dbe8dc50af3f + (uint) xc481dbe8dc50af3f < 0U)
      {
        if ((uint) xc481dbe8dc50af3f > uint.MaxValue)
          goto label_3;
      }
      else
        goto label_12;
