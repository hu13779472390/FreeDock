...
label_18:
      ...
      while ((uint) hollow - (uint) hollow < 0U);
      goto label_19;
label_17:
      return;
label_19:
...
label_8:
      if (m.Msg == 261)
        ...
        goto label_5;
label_12:
      if ((uint) wparam3 - (uint) wparam2 <= uint.MaxValue)
        goto label_8;
      else
        goto label_14;
label_13:
