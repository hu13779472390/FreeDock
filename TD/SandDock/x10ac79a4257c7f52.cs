...
label_10:;
    ...
    internal void xcdb145600c1b7224(bool x0b9c38731edfc369)
    {
      if (this.xdf67155884991aa8 != null)
        goto label_22;
label_21:
      if ((uint) x0b9c38731edfc369 + (uint) x0b9c38731edfc369 >= 0U)
        return;
      else
        return;
label_22:
      x87cf4de36131799d xd70b090e3181abff = this.x5fea292ffeb2c28c;
      if ((uint) x0b9c38731edfc369 + (uint) x0b9c38731edfc369 < 0U || !x0b9c38731edfc369)
        goto label_23;
label_15:
      int num1 = 1;
label_16:
      ...
      int num2;
      if ((uint) num2 < 0U || !x0b9c38731edfc369)
        goto label_18;
      else
        goto label_12;
label_11:
...
label_10:
      ...
      do
      {
        while (index < controlArray2.Length)
        {
          ...
          ++index;
          if ((uint) x0b9c38731edfc369 > uint.MaxValue)
            goto label_11;
        }
...
label_6:
        ...
        while ((uint) x0b9c38731edfc369 - (uint) x17cc8f73454a0462 < 0U);
        return;
label_39:
        return;
label_9:
        ...
        if (2 != 0 && ((uint) x0b9c38731edfc369 + (uint) x17cc8f73454a0462 > uint.MaxValue || !x0b9c38731edfc369))
        {
...
label_19:
          while ((uint) x17cc8f73454a0462 - (uint) x17cc8f73454a0462 >= 0U)
          {
            if (0 == 0)
            {
              if ((uint) x0b9c38731edfc369 + (uint) x0b9c38731edfc369 >= 0U)
...
label_12:
      ...
      if ((uint) flag1 + (uint) flag2 <= uint.MaxValue && flag1)
      {
        if (((flag2 ? 1 : 0) | -2) != 0)
          ;
      }
...
label_6:
      ...
      while ((uint) disposing + (uint) disposing > uint.MaxValue);
