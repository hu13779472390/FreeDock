...
label_21:
        ...
        while ((uint) flag3 + (uint) index1 < 0U);
        goto label_17;
label_26:
        layoutSystemBase = (LayoutSystemBase) enumerator.Current;
        goto label_14;
      ...
      {
        IDisposable disposable = enumerator as IDisposable;
        if ((uint) index1 + (uint) flag3 > uint.MaxValue || disposable != null)
          disposable.Dispose();
      }
label_37:
      return flag4;
...
label_15:
          ...
          while (((uint) index1 - (uint) num < 0U || (uint) index1 + (uint) num > uint.MaxValue) && (uint) num - (uint) index1 < 0U);
          goto label_14;
label_17:
...
label_27:
          ...
          {
            if ((uint) index1 - (uint) num <= uint.MaxValue)
            {
              if (0 == 0)
                goto label_22;
              else
...
label_14:
          ...
          if ((uint) num2 > uint.MaxValue)
          {
            ...
            goto label_8;
label_13:
          if ((uint) num2 - (uint) num1 < 0U || (num1 | 15) == 0)
            goto label_8;
          else
            goto label_8;
label_16:
...
label_11:
            ...
            if ((uint) flag > uint.MaxValue || controlLayoutSystem.Collapsed)
            {
              if (this.IsInContainer)
                goto label_10;
              else
...
label_4:
      ...
      protected override void OnRemoveComplete(int index, object value)
      {
        ...
        int num;
        if ((uint) num >= 0U && this.xd7a3953bce504b63)
          return;
        if (this.Count <= 1)
        {
          while (this.xb6a159a84cb992d6.xb6a159a84cb992d6 != null)
          {
            ...
            if ((uint) num - (uint) num >= 0U && this.Count != 1)
            {
              if ((uint) index - (uint) index > uint.MaxValue || (uint) num - (uint) index >= 0U)
              {
                if ((index & 0) == 0)
                {
                  if (this.Count != 0)
