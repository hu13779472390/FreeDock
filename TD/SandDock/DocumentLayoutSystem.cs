    ...
    public class DocumentLayoutSystem : ControlLayoutSystem
    {
      ...
      : this()
        ...
        internal override void x84b6f3c22477dacb(RendererBase x38870620fd380a6b, Graphics x41347a961b838962, Font x26094932cf7a9139)
        {
            ...
            int num;
            while ((uint)num <= uint.MaxValue && this.SelectedControl == null)
            {
        ...
        private void xc33f5f7a18a754cb(RendererBase x38870620fd380a6b, Graphics x41347a961b838962, Font x26094932cf7a9139, DockControl x43bec302f92080b9)
        {
            ...
            do
            {
                ...
                if (x43bec302f92080b9.AllowClose)
                {
                    ...
                    goto label_9;
                label_17:
                if ((uint)drawSeparator - (uint)drawSeparator < 0U || this.Controls.IndexOf(x43bec302f92080b9) == this.Controls.IndexOf(this.SelectedControl) - 1)
                {
                    drawSeparator = false;
                    goto label_13;
                }
                else if ((uint)drawSeparator - (uint)drawSeparator <= uint.MaxValue)
                    goto label_13;
                label_20:
            ...
            while ((uint)drawSeparator - (uint)drawSeparator > uint.MaxValue);
            goto label_32;
            label_3:
            if (0 == 0)
                goto label_9;
        ...
        private void x5d6e30ce9634c49e(RendererBase x38870620fd380a6b, Graphics x41347a961b838962, Rectangle xa358da7dd5364cab)
        {
            ...
            if (2 != 0)
            {
                foreach (DockControl dockControl in (CollectionBase) this.Controls)
                {
                    if ((num3 | 8) != 0)
                    {
                        Rectangle rectangle = dockControl.x123e054dab107457;
