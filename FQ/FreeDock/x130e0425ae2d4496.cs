...
namespace FQ.FreeDock
{
    class x130e0425ae2d4496
    {
        ...
        [DllImport("gdi32.dll")]
        private static extern IntPtr CreateBrushIndirect(x130e0425ae2d4496.LogBrush lb);
        ...
        public static void xe5e0d1644c72aafd(Control control, Rectangle rect)
        {
            ...
            x130e0425ae2d4496.PatBlt(new HandleRef(control, dc), rect.X, rect.Y, rect.Width, rect.Height, 0x5A0049);
