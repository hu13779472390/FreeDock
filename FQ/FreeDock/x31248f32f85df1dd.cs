    ...
    class x31248f32f85df1dd : xedb4922162c60d3d
    {
      ...
      : base(manager, container, sourceControlSystem, sourceControl, dockedSize, startPoint, dockingHints)
        ...
        private void xcaa196e697d8d7c5()
        {
            ...
            label_21:
            if ((!this.xe302f2203dc14a18(ContainerDockLocation.Right)) && !this.xe302f2203dc14a18(ContainerDockLocation.Top))
            {
        ...
        protected override xedb4922162c60d3d.DockTarget FindDockTarget(Point position)
        {
            ...
            if (true)
            {
                ...
                goto label_17;
            label_15:
            Rectangle x6ae4612a8469678e2 = Rectangle.Empty;
            ...
            goto label_15;
            label_26:
            if ((uint)index1 - (uint)(flag2 ? 1 : 0) < 0U)
            {
                if (-1 != 0)
                    goto label_68;
            }
            ...
            ++index2;
            label_46:
            x31248f32f85df1dd.x23d0185c2770c169 x23d0185c2770c169_2 = null;
